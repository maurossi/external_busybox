...
BUSYBOX_SRC_FILES = \
	$(filter-out libbb/appletlib.c editors/vi.c miscutils/adjtimex.c miscutils/dc.c miscutils/time.c networking/% util-linux/swaponoff.c modutils/modprobe-small.c util-linux/mount.c, $(shell cat $(BB_PATH)/busybox-$(BUSYBOX_CONFIG).sources)) \
...
BB_VER := 1.32.0
BUSYBOX_CFLAGS := $(BIONIC_CFLAGS) -Wno-constant-logical-operand -Wno-deprecated-declarations -Wno-user-defined-warnings -Wno-missing-field-initializers \
	-Werror=implicit -Wno-clobbered -Wno-pointer-arith \
